...
INSERT INTO Appointment VALUES(@UIDExam1,'Mathe Prüfung 1', 'Detail der Prüfung 1',(SELECT CONVERT(DATETIME,'13.06.2017',104)),(SELECT UID FROM Subject WHERE Code = 'Mat'))
INSERT INTO Exam VALUES (@UIDExam1,0,NULL,NULL)

INSERT INTO Appointment VALUES(@UIDExam2,'Mathe Prüfung 2', 'Detail der Prüfung 2',(SELECT CONVERT(DATETIME,'20.06.2017',104)),(SELECT UID FROM Subject WHERE Code = 'Mat'))
INSERT INTO Exam VALUES(@UIDExam2,1,(SELECT CONVERT(DATETIME,'18.06.2017',104)),'MyMail@MailService.com')

INSERT INTO Appointment VALUES(@UIDExam3,'Mathe Prüfung 3', 'Detail der Prüfung 3',(SELECT CONVERT(DATETIME,'25.06.2017',104)),(SELECT UID FROM Subject WHERE Code = 'Mat'))
...
INSERT INTO Appointment VALUES(@UIDExam1,'Englisch Prüfung 1', 'Detail der Prüfung 1',(SELECT CONVERT(DATETIME,'13.06.2017',104)),(SELECT UID FROM Subject WHERE Code = 'En'))
INSERT INTO Exam VALUES (@UIDExam1,0,NULL,NULL)

INSERT INTO Appointment VALUES(@UIDExam2,'Englisch Prüfung 2', 'Detail der Prüfung 2',(SELECT CONVERT(DATETIME,'20.06.2017',104)),(SELECT UID FROM Subject WHERE Code = 'En'))
INSERT INTO Exam VALUES(@UIDExam2,1,(SELECT CONVERT(DATETIME,'18.06.2017',104)),'MyMail@MailService.com')

INSERT INTO Appointment VALUES(@UIDExam3,'Englisch Prüfung 3', 'Detail der Prüfung 3',(SELECT CONVERT(DATETIME,'25.06.2017',104)),(SELECT UID FROM Subject WHERE Code = 'En'))
INSERT INTO Exam VALUES(@UIDExam3,0,NULL,NULL)
...
INSERT INTO Appointment VALUES(@UIDExam1,'Französisch Prüfung 1', 'Detail der Prüfung 1',(SELECT CONVERT(DATETIME,'13.06.2017',104)),(SELECT UID FROM Subject WHERE Code = 'Fr'))
INSERT INTO Exam VALUES (@UIDExam1,0,NULL,NULL)

INSERT INTO Appointment VALUES(@UIDExam2,'Französisch Prüfung 2', 'Detail der Prüfung 2',(SELECT CONVERT(DATETIME,'20.06.2017',104)),(SELECT UID FROM Subject WHERE Code = 'Fr'))
INSERT INTO Exam VALUES(@UIDExam2,1,(SELECT CONVERT(DATETIME,'18.06.2017',104)),'MyMail@MailService.com')

INSERT INTO Appointment VALUES(@UIDExam3,'Französisch Prüfung 3', 'Detail der Prüfung 3',(SELECT CONVERT(DATETIME,'25.06.2017',104)),(SELECT UID FROM Subject WHERE Code = 'Fr'))
INSERT INTO Exam VALUES(@UIDExam3,0,NULL,NULL)
...
INSERT INTO Appointment VALUES(@UIDExam1,'Deutsch Prüfung 1', 'Detail der Prüfung 1',(SELECT CONVERT(DATETIME,'13.06.2017',104)),(SELECT UID FROM Subject WHERE Code = 'De'))
INSERT INTO Exam VALUES (@UIDExam1,0,NULL,NULL)

INSERT INTO Appointment VALUES(@UIDExam2,'Deutsch Prüfung 2', 'Detail der Prüfung 2',(SELECT CONVERT(DATETIME,'20.06.2017',104)),(SELECT UID FROM Subject WHERE Code = 'De'))
INSERT INTO Exam VALUES(@UIDExam2,1,(SELECT CONVERT(DATETIME,'18.06.2017',104)),'MyMail@MailService.com')

INSERT INTO Appointment VALUES(@UIDExam3,'Deutsch Prüfung 3', 'Detail der Prüfung 3',(SELECT CONVERT(DATETIME,'25.06.2017',104)),(SELECT UID FROM Subject WHERE Code = 'De'))
INSERT INTO Exam VALUES(@UIDExam3,0,NULL,NULL)
...
INSERT INTO Appointment VALUES(@UIDHomework1,'Mathe Hausaufgabe 1', 'Detail der Hausaufgabe 1',(SELECT CONVERT(DATETIME,'10.06.2017',104)),(SELECT UID FROM Subject WHERE Code = 'Mat'))
INSERT INTO Homework VALUES (@UIDHomework1,0)

INSERT INTO Appointment VALUES(@UIDHomework2,'Mathe Hausaufgabe 2', 'Detail der Hausaufgabe 2',(SELECT CONVERT(DATETIME,'11.06.2017',104)),(SELECT UID FROM Subject WHERE Code = 'Mat'))
INSERT INTO Homework VALUES(@UIDHomework2,5)

INSERT INTO Appointment VALUES(@UIDHomework3,'Mathe Hausaufgabe 3', 'Detail der Hausaufgabe 3',(SELECT CONVERT(DATETIME,'12.06.2017',104)),(SELECT UID FROM Subject WHERE Code = 'Mat'))
...
INSERT INTO Appointment VALUES(@UIDHomework1,'Deutsch Hausaufgabe 1', 'Detail der Hausaufgabe 1',(SELECT CONVERT(DATETIME,'10.06.2017',104)),(SELECT UID FROM Subject WHERE Code = 'De'))
INSERT INTO Homework VALUES (@UIDHomework1,0)

INSERT INTO Appointment VALUES(@UIDHomework2,'Deutsch Hausaufgabe 2', 'Detail der Hausaufgabe 2',(SELECT CONVERT(DATETIME,'11.06.2017',104)),(SELECT UID FROM Subject WHERE Code = 'De'))
INSERT INTO Homework VALUES(@UIDHomework2,5)

INSERT INTO Appointment VALUES(@UIDHomework3,'Deutsch Hausaufgabe 3', 'Detail der Hausaufgabe 3',(SELECT CONVERT(DATETIME,'12.06.2017',104)),(SELECT UID FROM Subject WHERE Code = 'De'))
INSERT INTO Homework VALUES(@UIDHomework3,10)
...
INSERT INTO Appointment VALUES(@UIDHomework1,'Französisch Hausaufgabe 1', 'Detail der Hausaufgabe 1',(SELECT CONVERT(DATETIME,'10.06.2017',104)),(SELECT UID FROM Subject WHERE Code = 'Fr'))
INSERT INTO Homework VALUES (@UIDHomework1,0)

INSERT INTO Appointment VALUES(@UIDHomework2,'Französisch Hausaufgabe 2', 'Detail der Hausaufgabe 2',(SELECT CONVERT(DATETIME,'11.06.2017',104)),(SELECT UID FROM Subject WHERE Code = 'Fr'))
INSERT INTO Homework VALUES(@UIDHomework2,5)

INSERT INTO Appointment VALUES(@UIDHomework3,'Französisch Hausaufgabe 3', 'Detail der Hausaufgabe 3',(SELECT CONVERT(DATETIME,'12.06.2017',104)),(SELECT UID FROM Subject WHERE Code = 'Fr'))
INSERT INTO Homework VALUES(@UIDHomework3,10)
...
INSERT INTO Appointment VALUES(@UIDHomework1,'Englisch Hausaufgabe 1', 'Detail der Hausaufgabe 1',(SELECT CONVERT(DATETIME,'10.06.2017',104)),(SELECT UID FROM Subject WHERE Code = 'En'))
INSERT INTO Homework VALUES (@UIDHomework1,0)

INSERT INTO Appointment VALUES(@UIDHomework2,'Englisch Hausaufgabe 2', 'Detail der Hausaufgabe 2',(SELECT CONVERT(DATETIME,'11.06.2017',104)),(SELECT UID FROM Subject WHERE Code = 'En'))
INSERT INTO Homework VALUES(@UIDHomework2,5)

INSERT INTO Appointment VALUES(@UIDHomework3,'Englisch Hausaufgabe 3', 'Detail der Hausaufgabe 3',(SELECT CONVERT(DATETIME,'12.06.2017',104)),(SELECT UID FROM Subject WHERE Code = 'En'))
INSERT INTO Homework VALUES(@UIDHomework3,10)
